...
if (strain == "pau") {
  PA_info_genes <- data.table::fread("~/OneDrive - University of Otago/PL_2021/mapping_sheets_for_RNA_seq/PA14.csv")
} else if (strain == "pae") {
  PA_info_genes <- data.table::fread("~/OneDrive - University of Otago/PL_2021/mapping_sheets_for_RNA_seq/PAO1.csv")
} else if (strain == "pag") {
...
if (strain == "pau") {
  ...
  print(EnhancedVolcano(merge_1, lab = merge_1$PA14_Gene, x = "log2FoldChange",
    y = "padj", title = "volcano plot", pCutoff = 0.01, FCcutoff = 1.5))
  dev.off()
} else if (strain == "pae") {
  pdf("output_plots/volcano_plot_named.pdf")
  print(EnhancedVolcano(merge_1, lab = merge_1$PAO1_Gene, x = "log2FoldChange",
    y = "padj", title = "volcano plot", pCutoff = 0.01, FCcutoff = 1.5))
  dev.off()
} else if (strain == "pag") {
  pdf("output_plots/volcano_plot_named.pdf")
  print(EnhancedVolcano(merge_1, lab = merge_1$LESB_Gene, x = "log2FoldChange",
    y = "padj", title = "volcano plot", pCutoff = 0.01, FCcutoff = 1.5))
  dev.off()
} else {
  print("no match")
...
if (strain == "pau") {
  ...
  PAO1_GO_all <- data.table::fread("~/OneDrive - University of Otago/PL_2021/mapping_sheets_for_RNA_seq/PAO1_GO.csv")  #don't hardcode table - let user import
  PAO1_custom_list <- data.table::fread("~/OneDrive - University of Otago/PL_2021/mapping_sheets_for_RNA_seq/PAO1_custom.csv")
...
if (is.na(cluster_profiler_custom[1,5]) == "TRUE"){
   ...
   ggsave(filename = "output_plots/GO_gene_ratio_custom.pdf", width = 10)
   setwd(wor_dir)
 }
 if (is.na(cluster_profiler_customUP[1,5]) == "TRUE"){
   ...
   ggsave(filename = "output_plots/GO_gene_ratio_custom_upregulated.pdf", width = 10)
   setwd(wor_dir)
 }
 if (is.na(cluster_profiler_customDOWN[1,5]) == "TRUE"){
   ...
   ggsave(filename = "output_plots/GO_gene_ratio_custom_downregulated.pdf", width = 10)
   setwd(wor_dir)
 }
} else {
...
if (is.na(cluster_profiler_enriched_BP[1,5]) == "TRUE"){
  print("no significant enrichment terms")
    ...
    ggsave(filename = "output_plots/GO_gene_ratio_enriched_BP.pdf", width = 10)
    setwd(wor_dir)
  }
if (is.na(cluster_profiler_enriched_BPUP[1,5]) == "TRUE"){
  ...
  ggsave(filename = "output_plots/GO_gene_ratio_enriched_BP_upregulated.pdf", width = 10)
  setwd(wor_dir)
}
if (is.na(cluster_profiler_enriched_BPDOWN[1,5]) == "TRUE"){
  ...
  ggsave(filename = "output_plots/GO_gene_ratio_enriched_BP_downregulated.pdf", width = 10)
  setwd(wor_dir)
}
#CC only
...
if (is.na(cluster_profiler_enriched_CC[1,5]) == "TRUE"){
  print("no significant enrichment terms")
    ...
    ggsave(filename = "output_plots/GO_gene_ratio_enriched_CC.pdf", width = 10)
    setwd(wor_dir)
  }
if (is.na(cluster_profiler_enriched_CCUP[1,5]) == "TRUE"){
  ...
  ggsave(filename = "output_plots/GO_gene_ratio_enriched_CC_upregulated.pdf", width = 10)
  setwd(wor_dir)
}
if (is.na(cluster_profiler_enriched_CCDOWN[1,5]) == "TRUE"){
  ...
  ggsave(filename = "output_plots/GO_gene_ratio_enriched_CC_downregulated.pdf", width = 10)
  setwd(wor_dir)
}
}
...
if (is.na(clustprof_kegg[1,5]) == "TRUE"){
  ...
  ggsave(filename = "output_plots/KEGG_gene_ratio_enriched.pdf", width = 10)
  setwd(wor_dir)
  }
...
if (is.na(clustprof_keggDOWN[1,5]) == "TRUE"){
  ...
  ggsave(filename = "output_plots/KEGG_gene_ratio_enriched_downregulated.pdf", width = 10)
  setwd(wor_dir)
}
